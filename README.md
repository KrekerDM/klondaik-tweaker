...
- **Очистка, автозагрузка, службы, встроенные приложения, сеть** — каждое
  ...
  перетаскиванием, в очистке есть отдельная строка для папок приложений,
...
откуда именно берётся запись. Свою программу можно добавить перетаскиванием
на страницу или кнопкой: exe и bat ложатся значением в реестр, ярлык
копируется в папку автозагрузки.
