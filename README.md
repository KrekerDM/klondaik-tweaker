...
![Tweaks](https://img.shields.io/badge/%D0%A2%D0%B2%D0%B8%D0%BA%D0%BE%D0%B2-148-2EA043)
...
доступен весь каталог из 148 твиков с описанием, чем именно каждый рискует.

![Обзор системы](docs/screenshot-main.png)

## Что умеет

- **148 твиков** в трёх уровнях риска, каждый с описанием на русском и
  английском: что делает, зачем и чем вы за это платите.
- **Подбор по вопросам** — до 16 вопросов, лишние отсеиваются по железу.
...
- **Очистка, автозагрузка, службы, встроенные приложения, сеть** — каждое
  действие тоже пишется в журнал.
...
- **Русский и английский** интерфейс, переключается без перезапуска.
...
Пятнадцать категорий, три уровня риска, поиск по названию и описанию, четыре
...
На Windows 10 21H1 в виртуальной машине: 149 из 149 твиков применились и
откатились с побайтовым совпадением состояния, 26 из 26 проверок бэкенда, 23 из
23 модулей. Сверка с эталонными твикерами: 99 значений реестра совпадают,
13 расходятся осознанно.
